...
exports.SubDepartmentRepository = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("typeorm");
const typeorm_2 = require("@nestjs/typeorm");
const sub_department_entity_1 = require("./entities/sub-department.entity");
let SubDepartmentRepository = class SubDepartmentRepository {
    constructor(repository) {
        this.repository = repository;
    }
    async create(subDepartmentData) {
...
exports.SubDepartmentRepository = SubDepartmentRepository = __decorate([
    ...
    __param(0, (0, typeorm_2.InjectRepository)(sub_department_entity_1.SubDepartment)),
    __metadata("design:paramtypes", [typeorm_1.Repository])
], SubDepartmentRepository);
//# sourceMappingURL=sub-department.repository.js.map